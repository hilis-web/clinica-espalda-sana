...
function loadUsers() {
  ...
  $.ajax({
    ...
    success: function (response) {
      let usersHTML =
        '<h3>Users</h3><table class="table table-striped table-bordered"><thead><tr><th>Name</th><th>Email</th><th>Phone</th><th>Additional Info</th><th>Created At</th></tr></thead><tbody>';
...
function loadArticles() {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      let articlesHTML =
        '<button type="button" class="btn btn-primary add-float" data-bs-toggle="modal" data-bs-target="#addArticlePopup">Add New Article </button><h3>Articles</h3> <div class="row">';
        ...
        response.forEach((article) => {
          ...
          articlesHTML += `
            <div class="col-lg-2 mb-4">
              <div class="card">
                <img src="${
                  article.images[0] || "default-image.jpg"
                ...
                <div class="card-body">
                  ...
                  <button class="btn btn-warning btn-sm" onclick="editArticle('${
                    article._id
                  }')">Edit</button>
        ...
        let calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          eventClick: function (info) {
            ...
            let popupContent = `
                        <div class="popup">
                            ...
                            <select id="newStatus">
                                ...
                                <option value="booked" ${
                                  currentStatus === "booked" ? "selected" : ""
                                }>Booked</option>
                                <option value="locked" ${
                                  currentStatus === "locked" ? "selected" : ""
                                }>Locked</option>
                            </select>
            ...
            $("#updateStatusBtn").click(function () {
              ...
              if (
                newStatus &&
                ["available", "booked", "locked"].includes(newStatus)
              ) {
  ...
  $.ajax({
    ...
    success: function (article) {
      ...
      const detailsHTML = `
          ...
          <p><strong>Comments Enabled:</strong> ${
            article.comments_enabled ? "Yes" : "No"
          }</p>
...
$("#addArticleForm").on("submit", function (e) {
  ...
  const articleData = {
    ...
    images: $("#addimages")
      .val()
      .split(",")
      .map((img) => img.trim()), // Split the text into an array
    videos: $("#addvideos")
      .val()
      .split(",")
      .map((vid) => vid.trim()),
